...
The architecture is implemented across three core files:
1. `manager.go` - Room creation, lookup, cleanup
2. `room.go` - PeerConnection setup, recording, subscriber management
3. `track.go` - RTP distribution logic

---

## Open Questions

None - architecture is stable and proven in production.
